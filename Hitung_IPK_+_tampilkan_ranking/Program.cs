    ...
    public class Program
    {
        ...
        static void Welcome()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Input Tidak Valid, Harap di isi dengan benar");
                    Welcome();
                }
            }
            catch (Exception e)
            ...
            while (true)
            {
                ...
                try
                {
                    if (user != null && user.PasswordHash == HashPassword(password))
                    {
                        ...
                        Console.WriteLine("\n[ Login berhasil! ]\n");
                        MainApp();
                        break; // Keluar dari loop login setelah berhasil
                    }
                    else
                    {
                        attempt++;
                        ...
                        {
                            Console.Write("\nAnda telah gagal login sebanyak 3 kali. Ingin mencoba lagi? (y/n): ");
                            string? choice = Console.ReadLine()?.ToLower();

                            while (choice != "y" && choice != "n")
                            {
                                Console.Write("Input tidak valid. Pilih 'y' untuk coba lagi, atau 'n' untuk keluar: ");
        ...
        // Method untuk tampilkan rangking berdasarkan IPK
        static void TampilkanRangking()
        {
            ...
            var daftarIPK = new List<(string Nama, double IPK)>(); // Tuple untuk simpan pasangan nama & IPK
